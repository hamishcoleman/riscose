...
static const char *clib_clib_names[185] =
{
  ...
  "CLIB_X_DOLLAR_STACK_OVERFLOW",
  "CLIB_X_DOLLAR_STACK_OVERFLOW_1",
  "CLIB_X_DOLLAR_UDIVIDE",
  "CLIB_X_DOLLAR_UREMAINDER",
  "CLIB_X_DOLLAR_DIVIDE",
  "CLIB_X_DOLLAR_DIVTEST",
  "CLIB_X_DOLLAR_REMAINDER",
  "CLIB_X_DOLLAR_MULTIPLY",
  "CLIB__RD1CHK",
  "CLIB__RD2CHK",
  "CLIB__RD4CHK",
  "CLIB__WR1CHK",
